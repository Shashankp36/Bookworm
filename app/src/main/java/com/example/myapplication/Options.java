...
public class Options extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      LinearLayout linearLayout= findViewById(R.id.lyout);
        ...
        end= new Button(getApplicationContext());
        end.setText("FINISH");
        end.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
