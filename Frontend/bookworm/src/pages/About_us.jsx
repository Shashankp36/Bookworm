...
const Contact = () => {
  return (
    <div className="bg-blue-50 text-gray-900 min-h-screen py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center text-indigo-600">
          Let's Connect
        </h2>

        <p className="text-gray-700 text-lg text-center mb-12">
          Got questions? Feedback? We'd love to hear from you! At <span className="font-semibold text-indigo-900">BookWorm</span>,
          we're here to make your reading and listening experience better every day.
        </p>

        {/* About Bookworm Section */}
        <div className="bg-white p-8 rounded-lg shadow-lg mb-16">
          <h3 className="text-3xl font-bold text-indigo-600 mb-4">About Bookworm</h3>
          ...
          <h4 className="text-2xl font-bold text-indigo-500 mt-6 mb-2">What We Offer:</h4>
          ...
          <h4 className="text-2xl font-bold text-indigo-500 mt-6 mb-2">Our Mission:</h4>
          <p className="text-gray-700">
            ...
            Whether you're a student, a casual reader, or an audiobook lover, <strong className="text-indigo-900">Bookworm</strong> is designed to cater to every need.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            <h1 className="text-2xl font-bold text-indigo-500 mb-4">Genres We Offer</h1> 
          ...
          <div>
            <h1 className="text-2xl font-bold text-indigo-500 mb-4">Supported Languages</h1> 
            <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-10 text-center">
          <h1 className="text-3xl font-bold text-indigo-500 mb-4">Our Details</h1>
